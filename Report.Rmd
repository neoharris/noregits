...
We decided to not use B due to the low age of the participants - we were unsure of the quality of data, and whether children this age could validly have concerns over their health.

```{r}

#Combining data 
# We decided to not use B due to the low age reported - unsure of quality of data
...
Assess the prevalence of health issues in the cohort (adjusting for other factors?).
